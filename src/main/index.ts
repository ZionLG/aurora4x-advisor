...
import { getAllArchetypeIds, getArchetype, validateIdeology, matchPersonality } from './advisor'
...
app.whenReady().then(() => {
  ...
  ipcMain.handle('advisor:getAllArchetypeIds', () => {
  ...
  ipcMain.handle('advisor:validateIdeology', (_event, ideology) => {
    return validateIdeology(ideology)
  })
