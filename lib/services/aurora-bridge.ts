...
class AuroraBridge {
  ...
  private doConnect(): void {
    ...
    try {
      ...
      this.ws.on('open', () => {
        console.warn('[AuroraBridge] Connected to', this._url)
        ...
        console.warn('[AuroraBridge] Sending ping to check protocol version...')
        this.send('ping', null)
          .then((payload) => {
            console.warn('[AuroraBridge] Ping response:', payload)
      ...
      this.ws.on('close', () => {
        console.warn('[AuroraBridge] Disconnected')
        const wasConnected = this._isConnected
        this._isConnected = false
  ...
  private scheduleReconnect(): void {
    ...
    this.reconnectTimer = setTimeout(() => {
      console.warn(`[AuroraBridge] Reconnecting in ${this.reconnectDelay}ms...`)
      this.doConnect()
